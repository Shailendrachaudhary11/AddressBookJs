...
// Function to Check for Duplicates using Array Filter
const isDuplicate = (firstName, lastName) => {
    return addressBook.some(contact => contact.firstName === firstName && contact.lastName === lastName);
};

// Function to Add a New Contact to Address Book with Duplicate Check
...
const getContactCount = () => addressBook.length;
...
try {
    ...
    const contact3 = new AddressBookContact("John", "Doe", "789 Elm St", "Chicago", "IL", "606001", "8765432109", "john.doe.new@example.com");
    addContact(contact3); // This should show a duplicate entry warning
