...
// Function to Search People by City
const searchByCity = (city) => {
    return addressBook.filter(contact => contact.city.toLowerCase() === city.toLowerCase());
};

// Function to Search People by State
const searchByState = (state) => {
    return addressBook.filter(contact => contact.state.toLowerCase() === state.toLowerCase());
};
...
try {
    ...
    console.log("\nSearch Result for People in 'New York':");
    searchByCity("New York").forEach(contact => console.log(contact.getDetails()));

    console.log("\nSearch Result for People in 'CA' (California):");
    searchByState("CA").forEach(contact => console.log(contact.getDetails()));
